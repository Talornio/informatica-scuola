  ...
  <div class="div3">
    <?php
        ...
        if (isset($_POST["nome"])) {
          ...
          echo "<h3>mannaggia bro non funziona</h3>";
          echo "<br>";
        }
  
        $strSQL = "select attori.nome, film.titolo, attori.codAttore from attori, film, recita ";
        $strSQL .= "where attori.nome = '$nome' and recita.codAttore = attori.codAttore ";
          ...
          if(mysqli_num_rows($row) > 0){
            while($data = mysqli_fetch_assoc($row)){
              ...
              echo $data["nome"]; // stampa il valore della colonna nome
               ...
               echo "<br>";
             echo "<h4>ID Attore: ";
      echo $data["codAttore"]; // stampa il valore della colonna titolo
      echo "</h4>";
      echo "<br>";
      echo "<h4>Nome film: ";
